...
let courses = [
  ...
  {
    id: 3,
    title: "Photoshop from A to Z",
    category: "Design",
    instructor: "John Doe",
    students: 75,
    status: "Active",
    price: 59.99,
    description: "Learn Photoshop from basics to advanced level",
    duration: 10,
    level: "intermediate",
    image: "developer.png",
  },
  {
    id: 4,
    title: "Illustrator from A to Z",
    category: "Design",
    instructor: "Jane Smith",
    students: 120,
    status: "Active",
    price: 69.99,
    description: "Learn Illustrator from basics to advanced level",
    duration: 12,
    level: "advanced",
    image: "developer.png",
  },
  {
    id: 5,
    title: "Adobe XD from A to Z",
    category: "Design",
    instructor: "John Doe",
    students: 90,
    status: "Active",
    price: 79.99,
    description: "Learn Adobe XD from basics to advanced level",
    duration: 8,
    level: "intermediate",
    image: "developer.png",
  },
  {
    id: 6,
    title: "Adobe After Effects from A to Z",
    category: "Design",
    instructor: "Jane Smith",
    students: 110,
    status: "Active",
    price: 89.99,
    description: "Learn Adobe After Effects from basics to advanced level",
    duration: 10,
    level: "advanced",
    image: "developer.png",
  },
